    ...
    return (
        <div className='p-4'>
            ...
            <div className="mt-10 flex justify-center">
                <Link to='/reminder'>
                    <img className='hover:bg-slate-800' src="./addpill.png" alt="" />
                </Link>
            </div>
            ...
            <div className="mt-20 flex justify-center">
                <Link to='/add-medicine' className="text-center rounded-lg w-1/2 focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">
                    ADD MEDICINE
                </Link>
            </div>
